class FirstLevel extends Phaser.Scene {
    ...
    update() {
        ...
        else if (this.isPointerDown && !this.wallCollide) {
    ...
    createSafeGroup() {
        this.startPlace = this.add.tileSprite(120, 335, 100, 18, 'startPlace');
        ...
        this.bush = this.add.tileSprite(620, 335, 100, 18, 'bush');
    ...
    createWall() {
        this.wall1 = this.add.tileSprite(380, 350, 650, 10, 'wall');
        ...
        this.wall2 = this.add.tileSprite(380, 200, 650, 10, 'wall');
        ...
        this.wall3 = this.add.tileSprite(60, 280, 10, 150, 'wall');
        ...
        this.wall4 = this.add.tileSprite(700, 280, 10, 150, 'wall');
